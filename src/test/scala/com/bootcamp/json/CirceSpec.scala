...
object CirceSpec {
  ...
  private val dateTimeFormatter = DateTimeFormatter.BASIC_ISO_DATE

  implicit val config: Configuration = Configuration.default

  implicit val dateDecoder: Decoder[LocalDate] = decodeLocalDateWithFormatter(dateTimeFormatter)

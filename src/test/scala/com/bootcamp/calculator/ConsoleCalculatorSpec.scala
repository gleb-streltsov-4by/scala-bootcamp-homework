...
import com.bootcamp.calculator.ConsoleCalculator._
import org.scalatest.flatspec.AnyFlatSpec
import org.scalatest.matchers.should.Matchers.convertToAnyShouldWrapper
import org.scalatestplus.scalacheck.ScalaCheckDrivenPropertyChecks

class ConsoleCalculatorSpec extends AnyFlatSpec with ScalaCheckDrivenPropertyChecks {
  ...
  "calculate" should "correctly handle divide command with nones divison" in {
    val command = Divide(None, None)
    val error = ErrorMessage(s"calculating with $command ...")

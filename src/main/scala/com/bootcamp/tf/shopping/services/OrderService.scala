package com.bootcamp.tf.shopping.services

import cats.Monad
import cats.syntax.all._
import com.bootcamp.tf.shopping.clients.FileClient
import com.bootcamp.tf.shopping.domain.cart.CartItem
import com.bootcamp.tf.shopping.domain.money.Money
import com.bootcamp.tf.shopping.domain.order.{Order, OrderId}
import com.bootcamp.tf.shopping.domain.payment.PaymentId
